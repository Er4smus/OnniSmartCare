...
public class MalformedRequest extends Exception {
    ...
    private static final long serialVersionUID = -3214394785849600119L;

    public MalformedRequest() {
        super();
    }

    public MalformedRequest(String detailMessage, Throwable throwable) {
        super(detailMessage, throwable);
    }

    public MalformedRequest(String detailMessage) {
        super(detailMessage);
    }

    public MalformedRequest(Throwable throwable) {
        super(throwable);
    }
